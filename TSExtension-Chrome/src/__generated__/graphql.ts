...
export type GetUserQuery = { __typename?: 'Query', Viewer?: { __typename?: 'User', id: number, name: string } | null };
...
export type AddMediaToListMutation = { __typename?: 'Mutation', SaveMediaListEntry?: { __typename?: 'MediaList', id: number, status?: MediaListStatus | null } | null };
...
export const SearchMediaDocument = new TypedDocumentString(`
    query SearchMedia($id: Int, $search: String) {
...
export const AddMediaToListDocument = new TypedDocumentString(`
  ...
  SaveMediaListEntry(mediaId: $mediaId, status: PLANNING) {
    ...
    `) as unknown as TypedDocumentString<AddMediaToListMutation, AddMediaToListMutationVariables>;